defmodule Smarthood.Accounts do
  @moduledoc """
  ...
  alias Smarthood.Organizations.{UserOrganization}
  ...
  def current_user(conn) do
    ...
    if current_user, do: Smarthood.Repo.get(User, current_user.id) |> Repo.preload([:credential, :photo, :organizations])
