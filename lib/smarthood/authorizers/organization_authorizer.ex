defmodule Smarthood.Plugs.OrganizationAuthorizer do
	import Plug.Conn
  ...
  def call(%Plug.Conn{:private => %{:phoenix_action => action, :phoenix_controller => SmarthoodWeb.OrganizationController}} = conn, _default) when action in @actions do
