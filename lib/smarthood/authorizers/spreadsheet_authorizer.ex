defmodule Smarthood.Plugs.SpreadsheetAuthorizer do
	import Plug.Conn
  ...
  def call(%Plug.Conn{:private => %{:phoenix_action => action, :phoenix_controller => SmarthoodWeb.SpreadsheetController}} = conn, _default) when action in @actions do
