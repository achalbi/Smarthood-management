defmodule Smarthood.Plugs.WorkStatusTypeAuthorizer do
	import Plug.Conn
  ...
  def call(%Plug.Conn{:private => %{:phoenix_action => action, :phoenix_controller => SmarthoodWeb.WorkStatusTypeController}} = conn, _default) when action in @actions do
